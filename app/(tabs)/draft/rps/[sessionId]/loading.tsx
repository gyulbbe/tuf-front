    ...
    <div className="grid gap-4">
      <SurfaceCard className="p-6 sm:p-8">
        <div className="animate-pulse space-y-4">
          ...
          <div className="h-10 w-72 rounded-lg bg-surface-muted" />
          <div className="h-5 w-full max-w-2xl rounded-lg bg-surface-muted" />
        ...
        {Array.from({ length: 2 }).map((_, index) => (
          <SurfaceCard key={index} className="p-5 sm:p-6">
            <div className="animate-pulse space-y-4">
              ...
              <div className="h-5 w-full rounded-lg bg-surface-muted" />
              <div className="h-20 w-full rounded-lg bg-surface-muted" />
            </div>
          </SurfaceCard>
        ))}
      </div>
